...
def should_trigger_llm(self, game_state, Q_values, top_3_actions, bomb_radius_data=None,
    ...
    """
    Determines if LLM should be consulted based on behavioral loops only.

    MINIMAL APPROACH: Only triggers when agent is stuck
    ...
    Args:
        ...
        plant_bomb_data: (Optional) Dict with bomb planting evaluation
    ...
    # ============================================================
    # ONLY TRIGGER: Behavioral Loops (Stuck/Shivering)
    # ============================================================
    # Let Maverick handle everything except when it gets stuck in loops
